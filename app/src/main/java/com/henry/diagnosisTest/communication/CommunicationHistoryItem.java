...
public class CommunicationHistoryItem extends CommunicationDefinitionIpm<ResSerializableBean<ArrayList<DiagnosisInfoList>>> {
    private int id;

    public CommunicationHistoryItem(int id) {
        this.id = id;
    }
