...
public class CommunicationViewpagerDetail extends CommunicationDefinitionIpm<ResSerializableBean<ArrayList<DiagnosisInfoList>>>{

    private int id;

    public CommunicationViewpagerDetail(int id) {
        this.id = id;
    }
