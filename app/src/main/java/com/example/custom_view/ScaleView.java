...
public class ScaleView extends AppCompatImageView implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
         //   setBackgroundResource(R.drawable.bg_dashgap);
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                dragDirection = getDirection(v, (int) event.getX(),//判断触摸区域
                        (int) event.getY());
            }
        ...
        private void bottom(View v, int dy) {
            ...
            if (oriBottom - oriTop - 2 * offset < 300) {
                oriBottom = 300 + oriTop + 2 * offset;
            }
        }
