...
public class FragmentContainerHelper {
    ...
    private ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            if(animation != null && animation.getAnimatedValue() != null) {
                ...
                float positionOffsetSum = Float.parseFloat(animation.getAnimatedValue().toString());
    ...
    public void handlePageSelected(int selectedIndex, boolean smooth) {
        ...
        if (smooth) {
            ...
            if (mScrollAnimator != null && mScrollAnimator.getAnimatedValue() != null) {
                //currentPositionOffsetSum = (Float) mScrollAnimator.getAnimatedValue();
                currentPositionOffsetSum = Float.parseFloat(mScrollAnimator.getAnimatedValue().toString());
